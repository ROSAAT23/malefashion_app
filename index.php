            ...
            <?php while($blog = $limit_blogs->fetch_assoc()) { ?>
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="blog__item">
                        <div class="blog_item_pic set-bg" data-setbg="<?php
                        echo 'img/blog/'.$blog['blog_image']; ?>"></div>
                        <div class="blog_item_text">
                            <span><img src="img/icon/calendar.png" alt=""> <?php echo
                            date('d F Y', strtotime($blog['blog_date'])); ?></span>
